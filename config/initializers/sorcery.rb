...
Rails.application.config.sorcery.submodules = [:remember_me, :activity_logging, :brute_force_protection, :reset_password]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = Spree::UserMailer
    ...
    user.reset_password_expiration_period = 60*60*48
